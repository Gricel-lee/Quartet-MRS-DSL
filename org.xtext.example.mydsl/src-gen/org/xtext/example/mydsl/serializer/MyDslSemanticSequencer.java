...
public class MyDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_End(ISerializationContext context, End semanticObject) {
		...
		feeder.accept(grammarAccess.getEndAccess().getValueEIntParserRuleCall_4_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     ((type='more than' | type='less than' | type='exactly') number=EInt locations+=[Location|EString])
	 * </pre>
	 */
