...
/**
 * This is the item provider adapter for a {@link patterns.Accrue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AccrueItemProvider 
	 ...
	 * @generated
	 */
	public AccrueItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Accrue_measure_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Accrue_measure_feature", "_UI_Accrue_type"),
				 PatternsPackage.Literals.ACCRUE__MEASURE,
				 true,
				 false,
				 false,
	...
	protected void addRobotsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Accrue_robots_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Accrue_robots_feature", "_UI_Accrue_type"),
				 PatternsPackage.Literals.ACCRUE__ROBOTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Accrue"));
	}
	...
	public String getText(Object object) {
		String label = ((Accrue)object).getMeasure();
		return label == null || label.length() == 0 ?
			getString("_UI_Accrue_type") :
			getString("_UI_Accrue_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Accrue.class)) {
