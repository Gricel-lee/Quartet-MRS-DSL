...
/**
 * This is the item provider adapter for a {@link patterns.Relaxed} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelaxedItemProvider 
	 ...
	 * @generated
	 */
	public RelaxedItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Relaxed"));
	}
	...
	public String getText(Object object) {
		Relaxed relaxed = (Relaxed)object;
		return getString("_UI_Relaxed_type") + " " + relaxed.getConfidence();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Relaxed.class)) {
