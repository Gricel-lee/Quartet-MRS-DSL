...
/**
 * This is the item provider adapter for a {@link patterns.RepeatEvery} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepeatEveryItemProvider 
	 ...
	 * @generated
	 */
	public RepeatEveryItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RepeatEvery"));
	}
	...
	public String getText(Object object) {
		RepeatEvery repeatEvery = (RepeatEvery)object;
		return getString("_UI_RepeatEvery_type") + " " + repeatEvery.getT();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RepeatEvery.class)) {
