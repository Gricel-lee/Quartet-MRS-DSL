...
/**
 * This is the item provider adapter for a {@link patterns.Counteract} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CounteractItemProvider 
	 ...
	 * @generated
	 */
	public CounteractItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Counteract"));
	}
	...
	public String getText(Object object) {
		String label = ((Counteract)object).getType();
		return label == null || label.length() == 0 ?
			getString("_UI_Counteract_type") :
			getString("_UI_Counteract_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Counteract.class)) {
