...
/**
 * This is the item provider adapter for a {@link patterns.Exactly} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExactlyItemProvider 
	 ...
	 * @generated
	 */
	public ExactlyItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Exactly"));
	}
	...
	public String getText(Object object) {
		String label = ((Exactly)object).getType();
		return label == null || label.length() == 0 ?
			getString("_UI_Exactly_type") :
			getString("_UI_Exactly_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Exactly.class)) {
