...
/**
 * This is the item provider adapter for a {@link patterns.End} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EndItemProvider 
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_End_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_End_value_feature", "_UI_End_type"),
				 PatternsPackage.Literals.END__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		End end = (End)object;
		return getString("_UI_End_type") + " " + end.getValue();
	}
