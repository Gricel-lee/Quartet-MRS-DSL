...
/**
 * This is the item provider adapter for a {@link patterns.Visit1} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Visit1ItemProvider 
	 ...
	 * @generated
	 */
	public Visit1ItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Visit1"));
	}
	...
	public String getText(Object object) {
		String label = ((Visit1)object).getType();
		return label == null || label.length() == 0 ?
			getString("_UI_Visit1_type") :
			getString("_UI_Visit1_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Visit1.class)) {
