...
/**
 * This is the item provider adapter for a {@link patterns.AtLeast} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AtLeastItemProvider 
	 ...
	 * @generated
	 */
	public AtLeastItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AtLeast_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AtLeast_value_feature", "_UI_AtLeast_type"),
				 PatternsPackage.Literals.AT_LEAST__VALUE,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AtLeast"));
	}
	...
	public String getText(Object object) {
		String label = ((AtLeast)object).getMeasure();
		return label == null || label.length() == 0 ?
			getString("_UI_AtLeast_type") :
			getString("_UI_AtLeast_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AtLeast.class)) {
