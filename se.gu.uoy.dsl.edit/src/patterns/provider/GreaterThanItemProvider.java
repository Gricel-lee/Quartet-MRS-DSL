...
/**
 * This is the item provider adapter for a {@link patterns.GreaterThan} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GreaterThanItemProvider 
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GreaterThan_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GreaterThan_value_feature", "_UI_GreaterThan_type"),
				 PatternsPackage.Literals.GREATER_THAN__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((GreaterThan)object).getMeasure();
