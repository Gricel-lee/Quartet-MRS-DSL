...
/**
 * This is the item provider adapter for a {@link patterns.Minimize} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MinimizeItemProvider 
	 ...
	 * @generated
	 */
	public MinimizeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Minimize"));
	}
	...
	public String getText(Object object) {
		String label = ((Minimize)object).getMeasure();
		return label == null || label.length() == 0 ?
			getString("_UI_Minimize_type") :
			getString("_UI_Minimize_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Minimize.class)) {
