...
/**
 * This is the item provider adapter for a {@link patterns.Maximize} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MaximizeItemProvider 
	 ...
	 * @generated
	 */
	public MaximizeItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addRewardPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Maximize_reward_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Maximize_reward_feature", "_UI_Maximize_type"),
				 PatternsPackage.Literals.MAXIMIZE__REWARD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Maximize"));
	}
	...
	public String getText(Object object) {
		String label = ((Maximize)object).getMeasure();
		return label == null || label.length() == 0 ?
			getString("_UI_Maximize_type") :
			getString("_UI_Maximize_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Maximize.class)) {
