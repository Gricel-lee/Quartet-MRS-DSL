...
/**
 * This is the item provider adapter for a {@link patterns.Repeat} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepeatItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Repeat_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Repeat_value_feature", "_UI_Repeat_type"),
				 PatternsPackage.Literals.REPEAT__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Repeat_type") + " " + repeat.getValue();
	}
