...
/**
 * This is the item provider adapter for a {@link patterns.After} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AfterItemProvider 
	...
	public String getText(Object object) {
		String label = ((After)object).getType();
		return label == null || label.length() == 0 ?
			getString("_UI_After_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(After.class)) {
