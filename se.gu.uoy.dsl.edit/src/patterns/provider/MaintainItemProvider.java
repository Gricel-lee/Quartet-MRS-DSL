...
/**
 * This is the item provider adapter for a {@link patterns.Maintain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MaintainItemProvider 
	 ...
	 * @generated
	 */
	public MaintainItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConditionDependent_condition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConditionDependent_condition_feature", "_UI_ConditionDependent_type"),
				 PatternsPackage.Literals.CONDITION_DEPENDENT__CONDITION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PatternsPackage.Literals.CONDITION_DEPENDENT__LOCATIONEVENT);
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Maintain"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_Maintain_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Maintain.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PatternsPackage.Literals.CONDITION_DEPENDENT__LOCATIONEVENT,
