...
/**
 * This is the item provider adapter for a {@link patterns.Within} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WithinItemProvider 
	 ...
	 * @generated
	 */
	public WithinItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addValue1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Within_value1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Within_value1_feature", "_UI_Within_type"),
				 PatternsPackage.Literals.WITHIN__VALUE1,
				 true,
				 false,
				 false,
	...
	protected void addValue2PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Within_value2_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Within_value2_feature", "_UI_Within_type"),
				 PatternsPackage.Literals.WITHIN__VALUE2,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addRewardPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Within_reward_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Within_reward_feature", "_UI_Within_type"),
				 PatternsPackage.Literals.WITHIN__REWARD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Within"));
	}
	...
	public String getText(Object object) {
		String label = ((Within)object).getMeasure();
		return label == null || label.length() == 0 ?
			getString("_UI_Within_type") :
			getString("_UI_Within_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Within.class)) {
