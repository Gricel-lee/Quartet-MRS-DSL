...
/**
 * This is the item provider adapter for a {@link patterns.LessThan} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LessThanItemProvider 
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LessThan_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LessThan_value_feature", "_UI_LessThan_type"),
				 PatternsPackage.Literals.LESS_THAN__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((LessThan)object).getMeasure();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LessThan.class)) {
