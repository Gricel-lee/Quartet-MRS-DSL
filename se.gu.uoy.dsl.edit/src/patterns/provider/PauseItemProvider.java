...
/**
 * This is the item provider adapter for a {@link patterns.Pause} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PauseItemProvider 
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pause_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pause_value_feature", "_UI_Pause_type"),
				 PatternsPackage.Literals.PAUSE__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Pause_type") + " " + pause.getT();
	}
