...
/**
 * This is the item provider adapter for a {@link patterns.Avoid} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AvoidItemProvider 
	 ...
	 * @generated
	 */
	public AvoidItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addConditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConditionBased_condition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConditionBased_condition_feature", "_UI_ConditionBased_type"),
				 PatternsPackage.Literals.CONDITION_BASED__CONDITION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PatternsPackage.Literals.CONDITION_BASED__LOCATIONEVENT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Avoid"));
	}
	...
	public String getText(Object object) {
		String label = ((Avoid)object).getType();
		return label == null || label.length() == 0 ?
			getString("_UI_Avoid_type") :
			getString("_UI_Avoid_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Avoid.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PatternsPackage.Literals.CONDITION_BASED__LOCATIONEVENT,
