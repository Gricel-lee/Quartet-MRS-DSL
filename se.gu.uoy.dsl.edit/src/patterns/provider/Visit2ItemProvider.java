...
/**
 * This is the item provider adapter for a {@link patterns.Visit2} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Visit2ItemProvider 
	 ...
	 * @generated
	 */
	public Visit2ItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Restricted_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Restricted_number_feature", "_UI_Restricted_type"),
				 PatternsPackage.Literals.RESTRICTED__NUMBER,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Visit2"));
	}
	...
	public String getText(Object object) {
		String label = ((Visit2)object).getType();
		return label == null || label.length() == 0 ?
			getString("_UI_Visit2_type") :
			getString("_UI_Visit2_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Visit2.class)) {
			case PatternsPackage.VISIT2__TYPE:
