...
/**
 * This is the item provider adapter for a {@link patterns.Patrol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PatrolItemProvider 
	 ...
	 * @generated
	 */
	public PatrolItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Patrol"));
	}
	...
	public String getText(Object object) {
		String label = ((Patrol)object).getType();
		return label == null || label.length() == 0 ?
			getString("_UI_Patrol_type") :
			getString("_UI_Patrol_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Patrol.class)) {
