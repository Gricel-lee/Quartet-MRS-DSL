...
/**
 * This is the item provider adapter for a {@link patterns.Conservation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConservationItemProvider 
	 ...
	 * @generated
	 */
	public ConservationItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conservation_measure_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conservation_measure_feature", "_UI_Conservation_type"),
				 PatternsPackage.Literals.CONSERVATION__MEASURE,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Conservation"));
	}
	...
	public String getText(Object object) {
		String label = ((Conservation)object).getMeasure();
		return label == null || label.length() == 0 ?
			getString("_UI_Conservation_type") :
			getString("_UI_Conservation_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Conservation.class)) {
