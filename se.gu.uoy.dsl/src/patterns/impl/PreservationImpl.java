 ...
 * </p>
 * <ul>
 *   <li>{@link patterns.impl.PreservationImpl#getMissions <em>Missions</em>}</li>
 *   <li>{@link patterns.impl.PreservationImpl#getMeasure <em>Measure</em>}</li>
 *   <li>{@link patterns.impl.PreservationImpl#getValue1 <em>Value1</em>}</li>
 *   <li>{@link patterns.impl.PreservationImpl#getValue2 <em>Value2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PreservationImpl extends MinimalEObjectImpl.Container implements Preservation {
	/**
	...
	protected EClass eStaticClass() {
		return PatternsPackage.Literals.PRESERVATION;
	}
	...
	public NotificationChain basicSetMissions(Missions newMissions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PatternsPackage.PRESERVATION__MISSIONS, oldMissions, newMissions);
	...
	public void setMissions(Missions newMissions) {
		if (newMissions != missions) {
			...
			if (missions != null)
				msgs = ((InternalEObject)missions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PatternsPackage.PRESERVATION__MISSIONS, null, msgs);
			if (newMissions != null)
				msgs = ((InternalEObject)newMissions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PatternsPackage.PRESERVATION__MISSIONS, null, msgs);
			msgs = basicSetMissions(newMissions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatternsPackage.PRESERVATION__MISSIONS, newMissions, newMissions));
	}
	...
	public void setMeasure(String newMeasure) {
		...
		measure = newMeasure;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatternsPackage.PRESERVATION__MEASURE, oldMeasure, measure));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MissionDependent.class) {
			switch (derivedFeatureID) {
				case PatternsPackage.PRESERVATION__MISSIONS: return PatternsPackage.MISSION_DEPENDENT__MISSIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MissionDependent.class) {
			switch (baseFeatureID) {
				case PatternsPackage.MISSION_DEPENDENT__MISSIONS: return PatternsPackage.PRESERVATION__MISSIONS;
				default: return -1;
			}
		}
